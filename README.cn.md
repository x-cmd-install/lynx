...
![lynx](https://repo.x-cmd.io/lynx.svg?lang=zh)
...
合计: **1,662,049** 行代码（覆盖前 5 种语言、共 **8609** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Cpp | 647,899 | 46,104 | 96,790 | 2814 |
| CHeader | 238,798 | 58,726 | 65,816 | 3591 |
| Json | 177,799 | 0 | 40 | 426 |
| Python | 160,548 | 14,931 | 22,204 | 726 |
| Java | 150,109 | 19,342 | 23,390 | 1052 |

## 源代码

- **上游仓库**: <https://github.com/lynx-family/lynx>
- **官网**: <https://lynxjs.org>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `4.0.2` (2026-09-04)
- **最近提交**: 2026-09-10
- **Release 含资产**: 26 个

## 流行度

- **Star**: 15,131 · **Fork**: 551 · **开放 issue**: 514 · **贡献者**: 122

## 累计统计

- **发布数**: 26 · **已合并 PR**: 5702 · **开放 PR**: 969 · **已关闭 issue**: 252 · **开放 issue**: 262 · **提交数**: 5449

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 3 | 632 | 196 | 11 | 50 | 354 |
| last60d | 2026-07-12 | 5 | 1113 | 271 | 16 | 71 | 669 |
| 90d | 2026-06-12 | 6 | 1545 | 340 | 17 | 74 | 988 |
| last180d | 2026-03-14 | 11 | 2957 | 493 | 30 | 100 | 1986 |
| 360d | 2025-09-15 | 19 | 4923 | 822 | 56 | 133 | 3528 |
| last720d | 2024-09-20 | 26 | 5702 | 969 | 251 | 262 | 5449 |
...
在 [repology.org](https://repology.org/project/lynx) 上共有 **209** 个发行版报告此项目。**48** 个 ✅ 已是最新上游版本，**146** 个 ⚠️ 使用旧版本。
...
lynx 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `lynx` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/lynx.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T22:06:35Z._
